...
TERMINOS_DOMINIO = {
    ...
    # Pago privado — FN corregido: "fui al particular" ES una falla del sistema
    # El modelo confundía mención de médico privado con ausencia de queja.
    # Ahora estos términos tienen peso propio como señal de falla sistémica.
    "particular", "privado", "privada",
    "medico_privado", "médico_privado",         # formas sin n-grama
    "clinica_privada", "clínica_privada",
    "gasto_bolsillo", "gasté", "gasté",         # variantes de gasto directo
    "pagué", "pague", "desembolso",
    "consulta_privada",
...
NGRAMAS_DOMINIO: list[tuple[str, str]] = [
    ...
    # ── N-gramas pago privado (FN corregido) ─────────────────────────────────
    # Estas frases señalan que la ineficiencia pública FORZÓ al ciudadano
    # a pagar de su bolsillo. Son quejas de alto impacto aunque mencionen
    # servicios privados. Se convierten en tokens de queja explícita.
    ("médico privado",          "medico_privado"),
    ("medico privado",          "medico_privado"),
    ("clínica privada",         "clinica_privada"),
    ("clinica privada",         "clinica_privada"),
    ("consulta privada",        "consulta_privada"),
    ("tuve que pagar",          "tuve_que_pagar"),
    ("me cobró",                "me_cobro"),
    ("me cobraron",             "me_cobraron"),
    ("pagar de mi",             "pagar_de_mi_bolsillo"),
    ("fui al particular",       "fui_al_particular"),
    ("acudí al particular",     "acudi_al_particular"),
    ("acudi al particular",     "acudi_al_particular"),
    ("gasto de bolsillo",       "gasto_bolsillo"),
    # ── N-gramas vacunación INFORMATIVA (FP corregido) ────────────────────────
    # Problema: "vacuna disponible", "ya me vacuné" se clasificaban como queja
    # porque "vacuna" tiene peso alto en el lexicon de queja.
    # Solución: los contextos de vacunación positiva/neutral se convierten en
    # el token "vacuna_info_neutral", que el modelo aprende a separar de
    # "no_hay_vacuna" (queja) y "sin_vacuna" (queja).
    ("vacuna disponible",       "vacuna_info_neutral"),
    ("hay vacuna",              "vacuna_info_neutral"),
    ("ya hay vacuna",           "vacuna_info_neutral"),
    ("ya me vacuné",            "vacuna_info_neutral"),
    ("ya me vacune",            "vacuna_info_neutral"),
    ("me vacuné",               "vacuna_info_neutral"),
    ("me vacune",               "vacuna_info_neutral"),
    ("campaña de vacunación",   "vacuna_info_neutral"),
    ("campana de vacunacion",   "vacuna_info_neutral"),
    ("esquema de vacunación",   "vacuna_info_neutral"),
    ("esquema de vacunacion",   "vacuna_info_neutral"),
    ("vacuna gratuita",         "vacuna_info_neutral"),
    ("vacuna contra influenza",       "vacuna_info_neutral"),
    ("vacuna antigripal",       "vacuna_info_neutral"),
    ("dónde vacunarme",         "vacuna_info_neutral"),
    ("donde vacunarme",         "vacuna_info_neutral"),
    ("cómo vacunarme",          "vacuna_info_neutral"),
    ("como vacunarme",          "vacuna_info_neutral"),
    # ── Bigramas ─────────────────────────────────────────────────────────────
...
EXCEPCIONES_LEMA: dict[str, str] = {
    ...
    # ── N-gramas pago privado (FN corregido) ──────────────────────────────────
    "medico_privado":           "medico_privado",
    "clinica_privada":          "clinica_privada",
    "consulta_privada":         "consulta_privada",
    "tuve_que_pagar":           "tuve_que_pagar",
    "me_cobro":                 "me_cobro",
    "me_cobraron":              "me_cobraron",
    "pagar_de_mi_bolsillo":     "pagar_de_mi_bolsillo",
    "fui_al_particular":        "fui_al_particular",
    "acudi_al_particular":      "acudi_al_particular",
    "gasto_bolsillo":           "gasto_bolsillo",
    # ── N-gramas vacunación informativa (FP corregido) ────────────────────────
    # Un solo token "vacuna_info_neutral" agrupa todos los contextos
    # de vacunación positiva/neutra para que no contaminen el lexicon de queja.
    "vacuna_info_neutral":      "vacuna_info_neutral",
}
